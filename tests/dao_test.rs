...
mod sqlite_tests {
    ...
    use kitx::sqlite::connection::init_db_pool;
    use kitx::sqlite::operations::Operations as SqliteOperations;
...
mod mysql_tests {
    ...
    use kitx::mysql::operations::Operations as MySqlOperations;
